...
$conexion=Conecta();
    ...
    if($_POST){
        ...
        if(empty($errores)){
            ...
            ?>
            <script>alert('Tarea Añadida.');window.location.href='../controladores/controlador_tabla_tareas.php'</script>
            <?php
            return anadirTarea($datos_tareas, $conexion);
        }else{
            include_once '../vistas/vista_formulario_añadir.php';
        }
